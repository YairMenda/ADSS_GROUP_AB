...
import DataAccessLayer.ProductController;
...
public class Product {
    ...
    public double avgSoldInMonth(){
        ...
        double daysFromFirstSale = (double)Duration.between(LocalDate.now(), minimumSellDate).toDays()+1;
